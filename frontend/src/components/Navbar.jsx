    ...
    <header className=" bg-base-100 drop-shadow-md">
      <div className="navbar w-[90%] max-w-5xl mx-auto">
        <div className="navbar-start">
          <Link
            to="/"
            className="hidden md:flex btn btn-ghost  text-3xl text-secondary hover:text-accent  ">
            COLLECTIQUE
          </Link>
          <Link
            to="/"
            className=" md:hidden   text-xl text-secondary hover:text-accent  ">
            COLLECTIQUE
          </Link>
        </div>
        ...
        <div className="navbar-end hidden xl:flex ">
          <ul className="menu menu-horizontal px-1 flex items-center">
            ...
            {/* Cart */}
            {!user?.isAdmin ? (
              <li className="dropdown dropdown-end pt-2">
